...
#------------------------------
    ...
    amrdata.refinement_ratios_x = [5,3]
    ...
    rundata.regiondata.regions.append([1, 2, 0., 10000., -180,0,0,90])
    rundata.regiondata.regions.append([1, 3, 0., 10000., -125,-122,0,90])
    rundata.regiondata.regions.append([1, 3, 0., 10000., -129,-124,48,90])
...
#-------------------
    ...
    topo_dir = '/Users/rjl/topo/etopo/'
    topo_path = os.path.join(topo_dir, 'etopo1_-150_-121_37_52_1min.asc')
    ...
    #dtopo_path = './f4p4s1out.tt3'
    dtopo_path = './f1p1s1out.tt3'
