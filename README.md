...
for more details and Clawpack installation instructions.
This apps repository is not installed along with Clawpack.  See
[documention on installing apps](https://www.clawpack.org/apps.html) for
more information.
